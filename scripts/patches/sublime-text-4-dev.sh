# WORKING, BUT WOULD BREAK THE NIX PACKAGE
# SOURCE:
# - first patches: gist [DOT] github [DOT] com [SLASH] skoqaq [SLASH] 3f3e8f28e23c881143cef9cf49d821ff?permalink_comment_id=4774625#gistcomment-4774625
# - last patch: gist [DOT] github [DOT] com [SLASH] skoqaq [SLASH] 3f3e8f28e23c881143cef9cf49d821ff?permalink_comment_id=4786328#gistcomment-4786328

xxd -c 0 -p sublime_text > sublime_text.txt
...
xxd -c 0 -r -p sublime_text.txt > $out/bin/sublime_text
