...
scoop update
scoop install adb anydesk audacity dark Delugia-Nerd-Font-Complete deno discord ffmpeg gallery-dl git github glazewm godot hide-volume-osd innounp JetBrains-Mono JetBrainsMono-NF-Mono krita lmms micro mkvtoolnix moonlight notepadplusplus npiperelay obsidian picotorrent powertoys ps-dotenv pwsh scoop-search starship sublime-text sudo thorium-avx2 ungoogled-chromium vcredist2022 vlc volume2 vscode winaero-tweaker windows-terminal yt-dlp zoxide
