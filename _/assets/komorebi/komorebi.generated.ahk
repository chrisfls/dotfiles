...
; Elephicon
Run, komorebic.exe float-rule exe "Elephicon.exe", , Hide
...
; Plexamp
Run, komorebic.exe identify-border-overflow-application exe "Plexamp.exe", , Hide
...
; QtScrcpy
; If you have disabled minimize/close to tray for this application, you can delete/comment out the next line
Run, komorebic.exe identify-tray-application exe "QtScrcpy.exe", , Hide
...
; WinZip (32-bit)
Run, komorebic.exe float-rule exe "winzip32.exe", , Hide

; WinZip (64-bit)
Run, komorebic.exe float-rule exe "winzip64.exe", , Hide
